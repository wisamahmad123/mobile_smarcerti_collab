...
class ChartPengguna extends StatelessWidget {
  final HomeController controller = Get.find<HomeController>();

  ChartPengguna({super.key});
            ...
            Container(
              ...
              child: Obx(() => SfRadialGauge(
                    axes: [
                      ...
                      RadialAxis(
                        minimum: 0,
                        maximum: controller.getTotalPelatihan().toDouble() +
                            10, // sedikit margin
                        radiusFactor:
                        ...
                        pointers: [
                          RangePointer(
                            value: controller.getTotalPelatihan().toDouble(),
                            width: 10,
                            cornerStyle: CornerStyle.bothCurve,
                      ...
                      RadialAxis(
                        minimum: 0,
                        maximum: controller.getTotalSertifikasi().toDouble() +
                            10, // sedikit margin
                        radiusFactor:
                        ...
                        pointers: [
                          RangePointer(
                            value: controller.getTotalSertifikasi().toDouble(),
                            width: 10,
                            cornerStyle: CornerStyle.bothCurve,
            ...
            Row(
              ...
              children: [
                LegendItem(
                  color: Colors.redAccent,
                  text: 'Pelatihan',
                  count: controller.getTotalPelatihan().toString(),
                ),
                LegendItem(
                  color: Colors.blueGrey,
                  text: 'Sertifikasi',
                  count: controller.getTotalSertifikasi().toString(),
                ),
              ],
            ),
          ],
