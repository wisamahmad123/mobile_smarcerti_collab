...
import 'package:mobile_smarcerti/app/modules/pelatihan/controllers/pelatihan_controller.dart';
import 'package:mobile_smarcerti/app/modules/pelatihan/views/detail_pelatihan_page.dart';
import 'package:mobile_smarcerti/app/modules/pelatihan/views/add_pelatihan_page.dart'; // Pastikan import sesuai
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color.fromARGB(255, 239, 84, 40), // Warna tombol
        foregroundColor: Colors.white, // Warna ikon
        child: const Icon(Icons.add), // Ikon di tombol
      ),
    );
  }
}
