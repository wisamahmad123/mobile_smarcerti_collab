class MataKuliahSertifikasi {
    ...
    DateTime createdAt;
    DateTime updatedAt;
    MataKuliahSertifikasiPivot pivot;
    ...
    factory MataKuliahSertifikasi.fromJson(Map<String, dynamic> json) => MataKuliahSertifikasi(
        idMatakuliah: json["id_matakuliah"],
        namaMatakuliah: json["nama_matakuliah"],
        kodeMatakuliah: json["kode_matakuliah"],
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        pivot: MataKuliahSertifikasiPivot.fromJson(json["pivot"]),
    );
...
class MataKuliahSertifikasiPivot {
    ...
    factory MataKuliahSertifikasiPivot.fromJson(Map<String, dynamic> json) => MataKuliahSertifikasiPivot(
